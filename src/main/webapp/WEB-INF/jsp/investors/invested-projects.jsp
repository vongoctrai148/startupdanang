        ...
        <div class="container">
            <div class="row subpage">
                <div class="col-sm-12 left">
                    <div class="navigation"><a href="/"><i class="fas fa-home"></i>Trang chủ</a><a href="/nha-dau-tu.html">Nhà đầu tư</a></div>
                    <div class="list_project">

                        <div class="filter_box">

                            <a class="active" href="/nha-dau-tu.html">Tất cả</a>
                            <a href="/nha-dau-tu.html?province_id=1">Trong nước</a>
                            <a href="/nha-dau-tu.html?province_id=2">Nước ngoài</a>
                        </div>

                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-3 item">
                                <div>
                                    <a href="about.html" target="_blank"><img src="/ndt/images/nhadautu/ct1.jpg" alt="Quỹ đổi mới công nghệ quốc gia" style="height: 140px;"></a>
                                    <div class="item_b">
                                        <c:forEach items="${investedProjects}" var="investors">
                                            <h3><a href="investors/details/${investors.project.id}">${investors.project.projectname}</a></h3>
                                            <p>

                                                    ${investors.project.content}
                                            </p>
                                            <span><a href="/investors/details/${investors.project.id}">Xem thêm</a></span>
                                        </c:forEach>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="brief_event">
                            <p style="text-align: center;"><a class="rounded" style="padding-right: 20px; padding-left: 20px;" href="/nha-dau-tu.html?limit=all"><i class="fas fa-angle-right"></i> Xem tất cả</a></p>
                        </div>
